...
## Welcome to ![](images/logos/SIAP_logo_2020_1800.png){width=10%}


This is an interactive tutorial^[*This document uses materials developed
by *Garrick Aden-Buie, Barret Schloerke, JJ Allaire*, the creators of the [https://rstudio.github.io/learnr/](learner) package] that should help you verify that you and  your computer are ready to use the materials developed for this course. 
