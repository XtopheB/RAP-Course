...
Welcome to the interactive tutorial designed for participants of the ***Subregional Training on Monitoring Financial Protection in Health***, to support their introduction to the R statistical software. This is an interactive tutorial that should help you verify that you and your computer are ready to use the materials developed for this course using R and RStudio.^[This document uses materials developed by *Garrick Aden-Buie, Barret Schloerke, JJ Allaire & Alexander Rossell Hayes* , the creators of the [learner](https://rstudio.github.io/learnr/) package. *This version is 2.3 (October 2023)*.]  
...
To see the list of packages that were loaded in the basic installation of RStudio, go the “Files/ Plots/ Packages and Help” pane and select the tab Packages. You can learn about the packages by searching the searching the packages by name in the Help tab.
